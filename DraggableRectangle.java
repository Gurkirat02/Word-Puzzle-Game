...
public class DraggableRectangle implements Drawable, Draggable{
    private String word;
    ...
    public DraggableRectangle(double x, double y, double dividerWidth, double dividerHeight, Color dividerColor){
        topLeftX = x;
        topLeftY = y;
        width = dividerWidth;
...
//    public DraggableRectangle(String aString, double x, double y){
//        word = aString;
//        bottomLeftX = x;
//        bottomLeftY = y;
//    }
